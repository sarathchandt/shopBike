...
const BikeSlidingAnimation = forwardRef(({setIsBottomSheetOpen}:BikeSlidingAnimationProps,ref) => {
  const translateX = useSharedValue<number>(-(WINDOW_WIDTH + WINDOW_WIDTH / 2));
